...
@section('content')
    <div class="card">
        <div class="card-header white-bg border-bottom-0 mb-3">
            <a style="float: left" href="/dashboard/categories/{{$type}}" title="Back" class="btn btn-outline-primary">
                <i class="fa fa-arrow-left mr-1" aria-hidden="true"></i> {{trans('dashboard_forms.back')}}
            </a>
        </div>
        <h2 class="text-center"> {{trans('dashboard_categories.create_' . $type . '_category')}} </h2>
        <div class="card-body">
